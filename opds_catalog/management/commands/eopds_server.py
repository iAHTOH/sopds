...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.pidfile = os.path.join(main_settings.BASE_DIR, config.EOPDS_SERVER_PID)
    ...
    def stop(self, pid):
        try:
            ...
            self.stdout.write("Error stopping eopds_server: %s"%str(e))
...
def daemonize():
    ...
    std_out = open(config.EOPDS_SERVER_LOG, 'a+')
