...
from eopds_web_backend import views
...
urlpatterns = [
    ...
    re_path(r'^read/(?P<book_id>[0-9]+)/(?P<page>[0-9]+)/$', views.Fb2ReaderView, name='fb2reader_page'),
    re_path(r'^read/(?P<book_id>[0-9]+)/$', views.Fb2ReaderView, name='fb2reader'),
