...
CONSTANCE_CONFIG = OrderedDict(
    [
        ...
        ("SOPDS_FB2TOEPUB", ("", _("Path to FB2-EPUB (EPUB2) converter program"))),
        ("SOPDS_FB2TOEPUB3", ("", _("Path to FB2-EPUB3 converter program"))),
        ("SOPDS_FB2TOKEPUB", ("", _("Path to FB2-KEPUB (Kobo) converter program"))),
        ("SOPDS_FB2TOMOBI", ("", _("Path to FB2-MOBI/AZW8 (Kindle) converter program"))),
        ("SOPDS_FB2TOKFX", ("", _("Path to FB2-KFX (Kindle) converter program"))),
        ("SOPDS_FB2TOPDF", ("", _("Path to FB2-PDF converter program"))),
        ("SOPDS_FB2TOTXT", ("", _("Path to FB2-TXT converter program"))),
        ("SOPDS_FB2TOMD", ("", _("Path to FB2-Markdown converter program"))),
        (
            "SOPDS_TEMP_DIR",
...
CONSTANCE_CONFIG_FIELDSETS = {
    ...
    "6. Converters Options": (
        "SOPDS_FB2TOEPUB", "SOPDS_FB2TOEPUB3", "SOPDS_FB2TOKEPUB",
        "SOPDS_FB2TOMOBI", "SOPDS_FB2TOKFX", "SOPDS_FB2TOPDF",
        "SOPDS_FB2TOTXT", "SOPDS_FB2TOMD", "SOPDS_TEMP_DIR",
    ),
    "7. Log & PID Files": (
        "SOPDS_SERVER_LOG",
        "SOPDS_SCANNER_LOG",
